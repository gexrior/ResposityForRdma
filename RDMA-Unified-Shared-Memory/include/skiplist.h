...
//        Node* Find(KeyType key) const;
        Node* Find(KeyValue& value) const;
...
template<typename KeyType,typename DataType>
SkipListNode<KeyType,DataType>* SkipList<KeyType,DataType>::Find(KeyValue& value) const
{
    Node* pre=head_;
    Node* curr=head_->next[level_-1];
    for(int i=level_-1;i>=0;i--)
    {
        ...
        while(curr!=NULL)
        {
            if(curr->keyvalue.first<value.first)
            {
                printf("curr->keyvalue.first<value.first\n");
                pre = curr;
                curr=curr->next[i];
            }
            else if(curr->keyvalue.first==value.first)
...
//                strcpy(value.second,key);
                if(curr->keyvalue.second == value.second){
                    printf("curr->keyvalue.second == value.second\n");
                    return curr;
                }
                else if(value.second < curr->keyvalue.second){
...
//                //add:xurui
////                strcpy(value.second,key);
//                if(curr->keyvalue.second == value)
//                    return curr;
//                else if(value < curr->keyvalue.second){
//                    pre = curr;
//                    curr=curr->next[i];
//                }
//                //add:e
